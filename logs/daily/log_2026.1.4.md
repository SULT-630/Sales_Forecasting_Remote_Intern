...
- best 加上price change ratio lag1 base + total
    - overall MAPE [test, train]：9.93，8.41 (如果只有base： 9.93， 8.52，如果只有total： 9.7575， 8.4679) *调整一下ewm的beta参数，即权重*
    - 最大MAPE： at sku_id = 
    - 特征重要性：
...
- max depth = 7
    - overall MAPE [test, train, valid]： 10.1013, 8.8605, 10.5811

- max depth = 6 *选这个*
    - overall MAPE [test, train, valid]： 10.0028, 9.9665, 10.6748

- max depth = 5
    - overall MAPE [test, train, valid]： 10.1824, 10.6614, 10.5185

- min_child_weight = 5
    - - overall MAPE [test, train, valid]： 9.9961, 9.9126, 10.7184

- min_child_weight = 10 *选这个*
    - overall MAPE [test, train, valid]： 10.0028, 9.9665, 10.6748

- min_child_weight = 20
    - - overall MAPE [test, train, valid]： 10.0586, 9.8845, 10.6554

- reg lamda = 3
    - overall MAPE [test, train, valid]： 10.0803， 10.0835， 10.6600

- reg lamda = 8 
    - overall MAPE [test, train, valid]： 10.0028, 9.9665, 10.6748

- reg lamda = 12 *选这个*
    - overall MAPE [test, train, valid]： 9.8829， 9.9372，10.6361

- reg lamda = 15 
    - overall MAPE [test, train, valid]： 9.9168， 9.2082， 10.5820

- learning rate = 0.02
    - overall MAPE [test, train, valid]： 10.0259, 10.1331, 10.6227

- learning rate = 0.03
    - overall MAPE [test, train, valid]： 10.0616, 10.0810, 10.5634

- learning rate = 0.04
    - overall MAPE [test, train, valid]： 10.0785, 10.1721, 10.5650

- learning rate = 0.05 *选这个*
    - overall MAPE [test, train, valid]： 9.8829， 9.9372，10.6361

- learning rate = 0.06
    - overall MAPE [test, train, valid]： 10.0336, 9.9267, 10.5619

- early stopping rounds = 20
    - overall MAPE [test, train, valid]： 9.9527, 10.8237, 10.7325

- early stopping rounds = 50 *选这个*
    - overall MAPE [test, train, valid]： 9.8829， 9.9372，10.6361

- early stopping rounds = 100
    - overall MAPE [test, train, valid]： 9.8765, 9.1944, 10.6660

- evaluation metric = MAPE
    - overall MAPE [test, train, valid]： 9.8829， 9.9372，10.6361

- evaluation metric = MAE
    - overall MAPE [test, train, valid]： 9.8775, 9.8386, 10.6492

- evaluation metric = RMSE *选这个* (1378)
    - overall MAPE [test, train, valid]： 9.8192, 9.6986, 10.6425

- 此时更换随机种子，best iteration差距很大 约等于400
- 更换valid为四周：
    - overall MAPE [test, train, valid]： 10.0730， 10.0512， 11.2846

- rounds = 100 (1713) -> (1544)
    - overall MAPE [test, train, valid]： 9.8913, 9.3505, 10.6601

- rounds = 150 (1713) -> (1544)
    - overall MAPE [test, train, valid]： 10.0747, 9.5100, 10.6600

- valid 3周， rounds = 100 (1326) -> (1371)
    - overall MAPE [test, train, valid]： 9.9710， 9.7390， 10.6817
## Issues Encountered
...
- 有没有什么好的fill na method （用最近值填充）
- 由于日期并非真实，手动标注节假日不太可行，有没有其他的可以代替节假日效应的因子

## Next Steps
- 模型体检：哪些 SKU / week 预测得最差？是否存在系统性偏差
    - 流量不稳定/发售初期/异常活动
- 尝试lgb模型，以及对比模型特征重要性，以及预测好坏的分布
- 考虑两个模型的融合
- 测试ema