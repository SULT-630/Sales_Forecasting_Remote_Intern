...
Purpose: Data Cleaning Module for Weekly SKU-Store Sales Panel Data
...
def explore_dataset(df: pd.DataFrame, target_col: str = "units_sold") -> None:
    """
    Run a minimal EDA checklist to build intuition (not final conclusions).
...
def main():
    ...
    explore_dataset(raw_df, target_col="units_sold")
